 ...
 *
 */
class RecipeFoodsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'updated_at' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        '_indexes' => [
            'recipe_foods_idx1' => ['type' => 'index', 'columns' => ['recipe_id'], 'length' => []],
            'recipe_foods_idx2' => ['type' => 'index', 'columns' => ['food_id'], 'length' => []],
        ],
        '_constraints' => [
